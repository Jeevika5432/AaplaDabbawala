    ...
    const initPayment = (data) => {
        ...
        const options = {
            ...
            handler: async (response) => {
                try {
                    const verifyApi =
                        "http://localhost:8800/api/pay/verifyPremium";
                    const { data } = await axios.post(
                        verifyApi,
        ...
        <div className="min-h-screen flex justify-center items-center mt-20 mb-20">
            <div className="">
                <div className="text-center font-semibold">
                    ...
                    <p className="pt-6 text-xl text-black-700 font-normal w-full px-8 md:w-full">
                ...
                <div className="pt-24 flex flex-row gap-32">
                        ...
                        <div className="pt-8">
                            ...
                            <p className="font-semibold text-gray-400 text-left pt-5">
                                ...
                                <span className="pl-2">
                                    ...
                                    Menu & Restaurant{" "}
                                    <span className="text-black px-8">
                                        Listings
                                    </span>
                                </span>
                            </p>
                    ...
                    <div className="w-80 p-8 bg-gray-900 text-center rounded-3xl text-white border-4 shadow-xl border-white transform scale-100">
                        ...
                        <div className="pt-8">
                            ...
                            <p className="font-semibold text-gray-400 text-left pt-5">
                                ...
                                <span className="pl-2">
                                    ...
                                    <span className="text-white px-8">
                                        Cards & Vouchers
                                    </span>
                                </span>
                            </p>
                        ...
                        <div className="absolute top-4 right-4">
                            <p className="bg-red-700 text-white font-semibold px-4 py-1 rounded-full uppercase text-xs">
                                Popular
                            </p>
                        </div>
                    </div>
